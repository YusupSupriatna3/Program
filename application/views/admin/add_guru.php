<div class="feature">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <h3 align="center" class="page-header">Form Data Guru</h3>
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form id="guru" action="<?php echo base_url(); ?>proses-add-guru" method="post">
              ...
              <div class="form-group">
                ...
                <label for="jurusan" class="error"></label>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <button style="margin-left:74%;" type="submit" class="btn btn-info">Add Guru</button>
              </div>
            </form>
          </div>
        </div>
