<div class="feature">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <h3 align="center" class="page-header">Form Edit Guru</h3>
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form id="editguru" action="<?php echo base_url(); ?>guru/proses_edit_guru/<?php echo $this->uri->segment(3); ?>" method="post">
              <?php foreach ($guru as $key): ?>
                <div class="form-group">
                  <label for="nip">Nip</label>
                  <input disabled type="text" class="form-control" id="nip" placeholder="Enter Nip" value="<?php echo $key['nip']; ?>">
                  <input type="hidden" class="form-control" id="nip" placeholder="Enter Nip" name="nip" value="<?php echo $key['nip']; ?>">
                  <label for="nip" class="error"></label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="role">
                    <option value="guru" <?php if ($key['role']=='guru') {
                        echo "selected";
                      } ?>>Guru</option>
                  </select>
                </div>
                <div class="form-group">
                  <button style="margin-left:74%;" type="submit" class="btn btn-info">Edit Guru</button>
                </div>
              <?php endforeach; ?>
            </form>
          </div>
