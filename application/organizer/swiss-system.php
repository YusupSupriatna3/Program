...
<nav class="nav-app">
	<div class="title-app mr-auto">
		...
		<span>Configure Stage Swiss System (Duel)</span>
	</div>
</nav>
			...
			<div class="row m-0 mb-3">
				...
				<div class="form-group col-md-6 col-12">
					...
					<select class="selectpicker bracket-group w-100 p-0" data-live-search="true">
						...
						<option selected data-subtext="Participants are grouped by score then, within a group, the strongest participant from the first half is paired with the strongest participant from the second half.">Score Group + Balance</option>
						<option data-subtext="Participants are grouped by score then, within a group, the strongest participant is paired with the weakest participant.">Score Group + Opposite</option>
						<option data-subtext="Participants are grouped by score then, within a group, participants are paired randomly.">Score Group + Random</option>
					</select>
				</div>
				<div class="col-12">
							...
							<div class="col-md-6 col-12 p-0">
								<div class="row m-0">
									<div class="col p-1">
										...
										<input type="number" class="form-control" name="win" id="win" placeholder="Win" value="2">
									</div>
									<div class="col p-1">
					...
					<fieldset class="fieldset-app">
						<legend class="legend-app">
							<label class="checkbox-legend">Match Bye
								<input type="checkbox" checked="checked">
								<span class="checkmark"></span>
							</label>
						</legend>
						<div>Awards points when a participant does not play because there is no possible opponent.</div>
						<div class="col-6 p-0">
							<div class="col-md-4 col-6 p-1">
								<input type="number" class="form-control" name="bye" id="bye" placeholder="Bye" value="1">
							</div>
						</div>
					</fieldset>
					<fieldset class="fieldset-app">
					...
					<fieldset class="fieldset-app">
						...
						<div class="form-row">
							<div class="form-group col-md-6 col-8">
								<select class="selectpicker bracket-group w-100 p-0" data-live-search="true">
									<option data-subtext="Most points obtained by the participant's opponents.">
										Buchholz
									</option>
									<option data-subtext="Most points obtained by the participant's opponents, except the best and worst results.">
										Median Buchholz
									</option>
									<option data-subtext="Most points obtained by the sum of points cumulated by the opponents on each round.">
										Cummulative Opponent's Score
									</option>
									<option data-subtext="Most points obtained by the sum of points cumulated on each round.">
										Cummulative
									</option>
									<option selected data-subtext="Most wins, then draws, and then losses obtained on all matches.">Match 
						...
						<div class="form-row">
							<div class="form-group col-md-6 col-8">
								<select class="selectpicker bracket-group w-100 p-0" data-live-search="true">
									...
									<option selected data-subtext="Most points obtained by the participant's opponents, except the best and worst results.">
										Median Buchholz
									</option>
									<option data-subtext="Most points obtained by the sum of points cumulated by the opponents on each round.">
										Cummulative Opponent's Score
