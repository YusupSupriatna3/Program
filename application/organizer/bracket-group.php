<div class="content-app">
	<nav class="nav-app-mobile d-flex p-1 d-none d-sm-block d-md-none">
		...
		<div class="logo m-auto" style="width: 100px;">
			<a href="<?php base_url()?>organizer"><img src="<?php echo base_url()?>assets/img/logo.png" class="w-100 icon-invert"></a>
		</div>
	</nav>
	<nav class="nav-app">
		<div class="title-app mr-auto">
			<img src="<?php echo base_url()?>assets/img/icon/icon-structure.svg" class="icon-app icon-invert mr-2">
			<span>Configure Stage Bracket Groups (Duel)</span>
		</div>
	</nav>
		...
		<div class="bg-white p-5">
			<form>
				<div class="row m-0 mb-3">
					...
					<div class="form-group col-md-6 col-12">
						<div><label class="mb-1"><small>Bracket Type</small></label></div>
