			...
			<div class="row">
				<div class="col-md-6 col-12">
					...
					<div class="form-group mb-3">
						...
						<input type="text" class="form-control" name="machineName" id="label" value="label">
					</div>
					<div class="form-group mb-3">
						<h3>Defaul Value</h3>
						<div><label class="mb-1"><small>Label</small></label></div>
						<input type="text" class="form-control mb-2" name="defaulValue" id="defaulValue" placeholder="Address">
						<input type="text" class="form-control mb-2" name="defaulValue" id="defaulValue" placeholder="Postal Code">
						<input type="text" class="form-control mb-2" name="defaulValue" id="defaulValue" placeholder="City">
						<input type="text" class="form-control mb-2" name="defaulValue" id="defaulValue" placeholder="Country">
					</div>
				</div>
				<div class="col-md-6 col-12">
