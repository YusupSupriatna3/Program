				...
				<div class="row">
					<div class="col-md-6 col-12">
						<div class="form-group mb-3">
							...
							<input type="text" class="form-control" name="label" id="label" value="Snapchat">
						</div>
						<div class="form-group mb-3">
							<label class="m-0"><small>Machine Name</small></label>
							<input type="text" class="form-control" name="machineName" id="label" value="snapchat">
						</div>
						<div class="form-group mb-3">
							<h3>Defaul Value</h3>
							<div><label class="mb-1"><small>Label</small></label></div>
							<input type="text" class="form-control" name="defaulValue" id="defaulValue">
						</div>
					</div>
					<div class="col-md-6 col-12">
